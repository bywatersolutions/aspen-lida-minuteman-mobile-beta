export const englishTranslations = {
     "lastUpdated": "2026-07-13T19:51:04.363Z",
     "en": {
          ...
          "freeze_indefinite_warning": "If a future date is not selected, the hold will be frozen until you thaw it.",
          "freeze_indefinite_checkbox": "Freeze this hold indefinitely",
          "freeze_hold_without_reactivation": "Freeze indefinitely",
          "freeze_hold_choose_reactivation": "Choose Thaw Date",
          ...
          "holds_ready_for_pickup": "Holds Ready",
          "holds_ready_for_pickup_message": "These titles are on their way to you from the library or are available online for you to use.",
          ...
          "select_new_pickup_area": "Select a new area to pickup your hold",
          "select_pickup_location": "Select a Pickup Location",
          "select_pickup_area": "Select a Pickup Area",
          ...
          "filter_by_all": "Show All",
          "filter_by_ils": "Filter by Physical Materials",
          "filter_by_hoopla": "Filter by Hoopla",
          "filter_by_cloud_library": "Filter by cloudLibrary",
          "filter_by_boundless": "Filter by Boundless",
          "filter_by_palace_project": "Filter by Palace Project",
          "sort_by": "Sort by",
          ...
          "error_deleting_account": "There was an error trying to delete your account. Please try again later or contact your library.",
          ...
          "sort_by_format": "Sort By Format",
          "sort_by_status": "Sort By Status",
          "status": "Status",
          "sort_by_source": "Sort By Source",
          "sort_by_date_placed": "Sort By Date Placed",
          "date_placed": "Date Placed",
          "sort_by_position": "Sort By Position",
          "position": "Position",
          "sort_by_pickup_location": "Sort By Pickup Location",
          "sort_by_library_account": "Sort By Library Account",
          "library_account": "Library Account",
          "sort_by_expiration": "Sort By Expiration",
          "expiration": "Expiration",
          "sort_by_date_added": "Sort By Date Added",
          "date_added": "Date Added",
          "sort_by_recently_added": "Sort By Recently Added",
          "recently_added": "Recently Added",
          "sort_by_user_defined": "Sort By User Defined",
          "user_defined": "User Defined",
          "sort_by_last_used": "Sort By Last Used",
          "sort_by_due_asc": "Sort By Due Date Ascending",
          "due_asc": "Due Date Ascending",
          "sort_by_due_desc": "Sort By Due Date Descending",
          "due_desc": "Due Date Descending",
          "sort_by_times_renewed": "Sort By Times Renewed",
          ...
          "checkouts_for_all": "All Checked Out Titles",
          "checkouts_for_ils": "Checked Out Physical Materials",
          "checkouts_for_libby": "Checked Out Titles for %1%",
          "checkouts_for_hoopla": "Checked Out Titles for Hoopla",
          "checkouts_for_cloud_library": "Checked Out Titles for cloudLibrary",
          "checkouts_for_boundless": "Checked Out Titles for Boundless",
          "checkouts_for_palace_project": "Checked Out Titles for Palace Project",
          "num_holds_ready_for_pickup": "%1% Ready for You",
          "hold_position_with_queue": "%1% out of %2%",
          "titles_on_hold_by_source": "Titles On Hold for %1%",
          "titles_on_hold_for_all": "All Titles On Hold",
          "titles_on_hold_for_ils": "Titles On Hold for Physical Materials",
          "titles_on_hold_for_libby": "Titles On Hold for %1%",
          "titles_on_hold_for_hoopla": "Titles On Hold for Hoopla",
          "titles_on_hold_for_cloud_library": "Titles On Hold for cloudLibrary",
          "titles_on_hold_for_boundless": "Titles On Hold for Boundless",
          "titles_on_hold_for_palace_project": "Titles On Hold for Palace Project",
          ...
          "unknown_login_error": "Unknown error logging in. Please check your connection and try again later.",
          ...
          "revoke_device_settings": "Revoke device permissions",
          ...
          "last_used": "Last Used",
          "in_use": "In Use",
          "my_notification_history": "My Notification History",
          "my_message": "My Message",
          "notification": "Notification",
          "notification_history": "Notification History",
          "notification_history_empty": "You do not have any notifications at this time.",
          ...
          "register_for_a_library_card": "Register for a Library Card",
          "self_registration": "Self Registration",
          "self_registration_message": "This page allows you to register as a patron of our library online. You will have limited privileges initially.",
          "register": "Register",
          "self_registration_success": "Congratulations, you have successfully registered for a new library card. You will have limited privileges initially. Please bring a valid ID to the library to receive a physical library card with full privileges.",
          "self_registration_error": "Sorry, we were unable to create a library card for you. You may already have an account or there may be an error with the information you entered. Please try again or visit the library in person (with a valid ID) so we can create a card for you.",
          ...
          "preferred_pickup_branch": "Preferred Pickup Branch",
          "alternate_pickup_location_1": "Alternate Pickup Location 1",
          "alternate_pickup_location_2": "Alternate Pickup Location 2",
          "bypass_pickup_location_prompt": "Bypass pickup location prompt when placing holds",
          "always_use_pickup_location": "Always use this pickup location",
          "already_on_hold": "This title is already on hold for you. Are you sure you want to place a duplicate hold?",
          "submit": "Submit",
          "forgot_barcode_error_message": "An unknown error occurred. Please contact the library for assistance.",
          "forgot_barcode_success_message": "Your request completed successfully. Please contact the library if you do not receive a message soon.",
          "campaigns": "Campaigns",
          "active_campaigns": "Active Campaigns",
          "enrolled_campaigns": "Your Campaigns",
          "past_campaigns": "Past Campaigns",
          "upcoming_campaigns": "Upcoming Campaigns",
          "past_enrolled_campaigns": "Your Past Campaigns",
          "linked_user_campaigns": "Linked User Campaigns",
          "enroll": "Enroll",
          "unenroll": "Unenroll",
          "opt_in_to_campaign_emails": "Opt in to Emails",
          "opt_out_of_campaign_emails": "Opt out of Emails",
          "milestone_progress": "Progress",
          "no_active_campaigns": "No active campaigns",
          "no_enrolled_campaigns": "No enrolled campaigns",
          "no_linked_user_campaigns": "No linked user campaigns",
          "no_past_campaigns": "No past campaigns",
          "no_past_enrolled_campaigns": "No past enrolled campaigns",
          "no_upcoming_campaigns": "No upcoming campaigns",
          "no_campaigns": "You have no campaigns",
          "activity_name": "Name",
          "activity_goal": "Goal",
          ...
          "campaign_action_button": "Actions",
          "campaign_loading_error": "Error loading campaigns",
          "campaigns_for_linked_user": "Campaigns for",
          "add_progress": "Add Progress",
          "delete_list": "Delete List?",
          "delete_list_confirmation": "Are you sure you want to delete this list? The list will be soft-deleted and can be restored within 30 days.",
          "delete_list_confirmation_no_restore": "Are you sure you want to delete this list?",
          "opt_out_soft_deletion": "Skip the recycle bin and permanently delete",
          "rotate_device_for_barcode": "Rotate your device to landscape mode to view the full barcode.",
          "should_add_to_list_group": "Add To List Group?",
          "add_to_list_group_no": "No, do not add to a group",
          "add_to_list_group_new": "Yes, create a new group",
          "add_to_list_group_existing": "Yes, add to an existing group",
          "new_list_group_name": "New List Group Name",
          "should_nest_list_group": "Nest within another group?",
          "nest_within_group_no": "No, do not nest within another group",
          "choose_existing_list_group": "Choose a List Group",
          "create_new_list_group": "Create New List Group",
          "create_list_group": "Create List Group",
          "rename_list_group": "Rename List Group",
          "rename_list_group_to": "Rename Group To",
          "move_list_group": "Move List Group",
          "move_list_group_to": "Move to List Group",
          "delete_list_group": "Delete List Group",
          "delete_list_group_confirmation": "Are you sure you want to delete this list group? All lists within the group will be moved to the parent group.",
          "should_delete_list_group": "Delete List Group?",
          "unassigned_lists": "Unassigned Lists",
          "list_group": "List Group",
          "no_list_group": "No Group",
          "select_new_parent": "Select a List Group",
          "notice_about_item": "Notice About Item",
          "does_barcode_match_item": "Does this barcode match whats on the item?",
          "open_api_error_log": "Open API Error Log",
          "api_error_log": "API Error Log (Last 24 Hours)",
          "clear_api_error_log": "Clear Logs",
          "api_error_log_empty": "No API errors in the past 24 hours",
          "total": "Total"
     }
};
